...
class CoarseQuadMesh(QuadMesh):
    ...
    def __init__(self):
        ...
        self.data['data']['attributes']['strips_density'] = {}
        self.data['data']['attributes']['vertex_coarse_to_dense'] = {}
        self.data['data']['attributes']['edge_coarse_to_dense'] = {}
        self.data['data']['attributes']['quad_mesh'] = None
        self.data['data']['attributes']['polygonal_mesh'] = None
    ...
    def from_quad_mesh(cls, quad_mesh, collect_strips=True, collect_polyedges=True, attribute_density=True):
        ...
        coarse_quad_mesh.data['data']['attributes']['vertex_coarse_to_dense'] = coarse_vertices_children
        coarse_quad_mesh.data['data']['attributes']['edge_coarse_to_dense'] = {u: {} for u in coarse_quad_mesh.vertices()}
        for (u, v), polyedge in coarse_edges_children.items():
            coarse_quad_mesh.data['data']['attributes']['edge_coarse_to_dense'][u][v] = polyedge
            coarse_quad_mesh.data['data']['attributes']['edge_coarse_to_dense'][v][u] = list(reversed(polyedge))
    ...
    def get_quad_mesh(self):
        return self.data['data']['attributes']['quad_mesh']

    def set_quad_mesh(self, quad_mesh):
        self.data['data']['attributes']['quad_mesh'] = quad_mesh

    def get_polygonal_mesh(self):
        return self.data['data']['attributes']['polygonal_mesh']

    def set_polygonal_mesh(self, polygonal_mesh):
        self.data['data']['attributes']['polygonal_mesh'] = polygonal_mesh
    ...
    def coarse_edge_dense_edges(self, u, v):
        ...
        return self.data['data']['attributes']['edge_coarse_to_dense'][u][v]
    ...
    def get_strip_density(self, skey):
        ...
        int
            The strip density.
        """
        return self.data['data']['attributes']['strips_density'][skey]
    ...
    def get_strip_densities(self):
        ...
        """
        return self.data['data']['attributes']['strips_density']
    ...
    def set_strip_density(self, skey, d):
        ...
        d : int
            A density parameter.
        """
        self.data['data']['attributes']['strips_density'][skey] = d
...
if __name__ == '__main__':
    ...
    # # print(mesh_0.number_of_strips())
    # # print(mesh_0.data['data']['attributes']['vertex_coarse_to_dense'])
    # # print(mesh_0.data['data']['attributes']['edge_coarse_to_dense'])
