...
class CoarsePseudoQuadMesh(PseudoQuadMesh, CoarseQuadMesh):
    ...
    def densification(self, edges_to_curves=None):
        ...
        self.get_quad_mesh().data['data']['attributes']['face_pole'] = face_pole
...
if __name__ == '__main__':
    ...
    # data = {}
    # for key, value in mesh.data['data']['attributes']['face_pole'].items():
    #     data[int(key)] = value
    # mesh.data['data']['attributes']['face_pole'] = data
    # # #print(mesh.data['data']['attributes']['face_pole'][str(4)])
