...
from compas_singular.algorithms.decomposition.skeletonisation import Skeleton
...
from compas_singular.algorithms.decomposition.propagation import quadrangulate_mesh
