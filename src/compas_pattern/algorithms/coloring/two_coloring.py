...
from compas_pattern.datastructures.mesh_quad.grammar_pattern import collateral_strip_deletions
from compas_pattern.datastructures.mesh_quad.grammar_pattern import total_boundary_deletions
