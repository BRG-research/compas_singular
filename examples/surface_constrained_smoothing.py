...
for guid in guids:
    ...
    constraints = automated_smoothing_surface_constraints(mesh, srf)
    constrained_smoothing(mesh, kmax = 75, damping = .5, constraints = constraints, algorithm = 'area')
    
    new_guid = draw_mesh(mesh)
